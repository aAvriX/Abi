...
var petalPartMarkup = '<div class="box"><div class="shape"></div></div>';
var maxParts = 20;
var maxPetals = 6;
...
function createBox(box, pos) {
  ...
  // 🎨 COLOR DE LOS PÉTALOS (aquí puedes cambiar a amarillo)
  var baseHue = 50;
  var hueVariation = 10;
  var saturation = 85 + (20 * pos / maxParts);
...
document.addEventListener('DOMContentLoaded', drawGalaxy);  var mainContent = document.getElementById('main-content');
